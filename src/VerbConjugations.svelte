...
<section id="section-8" class="section-divider-ipg">
  ...
  <p class="paragraph-1-ipg">
    Verbs are divided in Pāli into seven different groups or <a href="#section8-note-42" class="notes-ipg" id="section8-note-42-rtn">classes<sup class="sup-spacing-ipg">42</sup></a> according to the derivations and insertions their root undergoes when conjugated. The subsequent examples should <a href="#section8-note-43" class="notes-ipg" id="section8-note-43-rtn">suffice<sup class="sup-spacing-ipg">43</sup></a>:
  </p>
  ...
  <ul class="para-list-ipg">  
    <li><a href="#section8-note-44" class="notes-ipg" id="section8-note-44-rtn">three persons (third, second and first)<sup class="sup-spacing-ipg">44</sup></a>;</li>
    <li>two numbers: singular and plural;</li> 
    <li>six tenses: present (<span class="italic-w-ipg">gacchati</span>), <a href="#section8-note-45" class="notes-ipg" id="section8-note-45-rtn">imperfect<sup class="sup-spacing-ipg">45</sup></a>, <a href="#section8-note-46" class="notes-ipg" id="section8-note-46-rtn">aorist<sup class="sup-spacing-ipg">46</sup></a>(<span class="italic-w-ipg">agacchi</span>, altern: <span class="italic-w-ipg">agāma</span>; <span class="italic-w-ipg">agamī</span>; <span class="italic-w-ipg">agañchi</span>), <a href="#section8-note-47" class="notes-ipg" id="section8-note-47-rtn">perfect<sup class="sup-spacing-ipg">47</sup></a>, future (<span class="italic-w-ipg">gacchissati</span>), and conditional (<span class="italic-w-ipg">agacchissa</span>);</li>
  ...
  <ul class="para-list-ipg"> 
    ...
    <li>Present participles are formed by adding <span class="italic-w-ipg">-nta-</span>; <span class="italic-w-ipg">-ntī-</span> or <span class="italic-w-ipg">-māna-</span>; <span class="italic-w-ipg">-mānā-</span> to the <a href="#section8-note-49" class="notes-ipg" id="section8-note-49-rtn">verbal base<sup class="sup-spacing-ipg">49</sup></a>. They function as adjectives and agree in gender, number and case with the nouns they qualify. They are declined like the respective nouns and may be translated with the help of: ‘while’: <span class="italic-w-ipg">gacchanta</span>; <span class="italic-w-ipg">gacchant</span> – (while) going.</li>
