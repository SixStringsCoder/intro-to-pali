...
<section id="section-8" class="section-divider-ipg">
  ...
  <ul class="para-list-ipg">  
    ...
    <li>six tenses: present (<span class="italic-w-ipg">gacchati</span>), <a href="#section8-note-45" class="notes-ipg" id="section8-note-45-rtn">imperfect</a><sup class="sup-spacing-ipg">45</sup>, <a href="#section8-note-46" class="notes-ipg" id="section8-note-46-rtn">aorist</a><sup class="sup-spacing-ipg">46</sup>(<span class="italic-w-ipg">agacchi</span>, altern: <span class="italic-w-ipg">agāma</span>; <span class="italic-w-ipg">agamī</span>; <span class="italic-w-ipg">agañchi</span>), <a href="#section8-note-47" class="notes-ipg" id="section8-note-47-rtn">perfect</a><sup class="sup-spacing-ipg">47</sup>, future (<span class="italic-w-ipg">gacchissati</span>), and conditional (<span class="italic-w-ipg">agacchissa</span>);</li>
  ...
  <ul class="para-list-ipg">  
    ...
    <li>The imperative mood expresses commands, benediction or wishes. It is mainly used in the active voice with the following personal endings: <span class="italic-w-ipg">-tu; -hi; -ntu;</span> -tha for the 3rd and 2nd. <a href="#section8-note-48" class="notes-ipg" id="section8-note-48-rtn">These are added to the stem.</a><sup class="sup-spacing-ipg">48</sup></li>
  </ul>
  ...
  <ul class="para-list-ipg"> 
    ...
    <li>Present participles are formed by adding <span class="italic-w-ipg">-nta-</span>; <span class="italic-w-ipg">-ntī-</span> or <span class="italic-w-ipg">-māna-</span>; <span class="italic-w-ipg">-mānā-</span> to the <a href="#section8-note-49" class="notes-ipg" id="section8-note-49-rtn">verbal base</a><sup class="sup-spacing-ipg">49</sup>. They function as adjectives and agree in gender, number and case with the nouns they qualify. They are declined like the respective nouns and may be translated with the help of: ‘while’: <span class="italic-w-ipg">gacchanta</span>; <span class="italic-w-ipg">gacchant</span> – (while) going.</li>
